...
- プリセットをワンタップで適用（マイセット、タバタ 20/10×8、HIIT標準 30/15×10、ノルウェー式HIIT 240/180×4）
...
├── js/i18n.js              # 多言語対応（ja / en / zh の文言辞書）
├── js/app.js               # UI制御・音声・Wake Lock・localStorage・言語切替
├── test/timer.test.js      # タイマーロジックのユニットテスト
├── test/i18n.test.js       # 多言語辞書のユニットテスト
