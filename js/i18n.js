...
;(function (globalScope, factory) {
  ...
  const MESSAGES = Object.freeze({
    ja: {
      ...
      savePersonal: '現在の設定をマイセットに保存',
      fullscreen: { enter: '全画面表示', exit: '全画面表示を終了' },
      totalLabel: '合計',
      soundLabel: 'サウンド ON',
      start: 'スタート',
      pause: '一時停止',
    ...
    en: {
      ...
      savePersonal: 'Save current settings as My Set',
    ...
    zh: {
      ...
      savePersonal: '将当前设置保存为我的组合',
      fullscreen: { enter: '全屏显示', exit: '退出全屏' },
      totalLabel: '总计',
      soundLabel: '声音开启',
      start: '开始',
      pause: '暂停',
